...
<body>
   ...
   <section class="aboutflex">
         <img src="images/logo/seeele.png" alt="seele">
         <p>اول متجر عراقي لمعدات الصوت الاحترافية</p>
   </section>

   <section class="socialmedia">
      <a href="https://www.instagram.com/seele.audio/"><i class="fa-brands fa-instagram"></i></a>
      <a href="https://facebook.com/SEELE.AUDIO/"><i class="fa-brands fa-facebook"></i></a>
   </section>
   ...
   <section class="contact">
      <form action="" method="post">
         ...
         <input type="email" name="email" placeholder="E-mail" required maxlength="50" class="box">
